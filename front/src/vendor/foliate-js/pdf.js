...
import pdfWorkerURL from './vendor/pdfjs/pdf.worker.mjs?url'
...
const cMapUrl = withTrailingSlash(
    new URL(/* @vite-ignore */ './vendor/pdfjs/cmaps/', import.meta.url).toString(),
)
const standardFontDataUrl = withTrailingSlash(
    new URL(
        /* @vite-ignore */ './vendor/pdfjs/standard_fonts/',
        import.meta.url,
    ).toString(),
)
